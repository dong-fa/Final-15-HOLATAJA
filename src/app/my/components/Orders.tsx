      ...
      "products": [
        {
          ...
          "extra": {
            ...
            "full_description": "우측 넘버 패드를 자주 사용하시는 분들을 위한 100키 구성 풀배열 기계식 키보드 AIR96 V2! QMK&VIA 지원 및 고성능 칩셋과 대용량 배터리가 탑재되어 있습니다. 완벽한 성능과 예쁜 디자인, 안정적인 타건감까지 느낄 수 있는 NUPHY AIR96 V2를 만나보세요.",
            "function-tag": "",
        ...
        },
        {
          ...
          "extra": {
            ...
            "description": "새롭게 돌아온 75% 배열 83키 구성 텐키리스 기계식 키보드 Halo75 V2를 소개합니다. 업그레이드 된 성능과 감각적인 디자인, 더욱 영롱해진 Halo 라이트와 백라이트 효과! 독특한 감성을 갖고 있는 NUPHY Halo75 V2로 즐거운 타이핑 경험을 느껴보세요.",
            "function-tag": "",
            "soundfile-path": "files/febc13-final15-emjf/_YzMqZjVu.m4a"
          }
        },
        {
          ...
          "extra": {
            ...
            "description": "프리미엄 풀 알루미늄 프레임, 자석축 기계식 키보드 BH65는 자체 개발 N.U.A 차세대 자석축 알고리즘으로 키 입력 습관에 따라 동적으로 키를 보정합니다. 8KHz 폴링레이트, 작동 지점 조절, 래피드 트리거, 하이퍼 탭 등 다양한 기능을 지원하는 65% 배열 BH65로 새로운 플레이를 즐겨보세요.",
            "function-tag": "",
            "soundfile-path": "files/febc13-final15-emjf/_YzMqZjVu.m4a"
          }
        }
      ...
      "products": [
        {
          ...
          "extra": {
            ...
            "description": "콤팩트한 사이즈와 디자인은 그대로! 편의성과 성능은 업그레이드 되어 돌아왔습니다. AIR75 V2는 실제 사용량이 가장 많은 대중적인 75% 배열 텐키리스 기계식 키보드입니다. 안정적인 타건감, 디자인 및 성능까지 완벽해진 NUPHY AIR75 V2로 세 마리 토끼를 모두 잡은 데스크테리어를 완성해보세요.",
            "function-tag": "",
            "soundfile-path": "files/febc13-final15-emjf/_YzMqZjVu.m4a"
          }
        },
